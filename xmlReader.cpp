...
//
//void XmlReader::xmlReadTitleInfo()
//{
//    XMLDocument doc;
...
//        return;
//    }
//    XMLElement* root = doc.FirstChildElement("Department");
//
...
//    printf("============================================\n");
//}
//void XmlReader::xmlReadSelfInfo()
//{
//    XMLDocument doc;
//    doc.LoadFile("hierarchy_tree.xml");
//    if (doc.ErrorID() != 0) {
...
//    printf("================================================\n");
//}
//void XmlReader::xmlReadContactInfo()
//{
//    XMLDocument doc;
//    doc.LoadFile("hierarchy_tree.xml");
//    if (doc.ErrorID() != 0) {
...
//
//}
//void XmlReader::xmlReadMeetingInfo()
//{
//    XMLDocument doc;
//    doc.LoadFile("hierarchy_tree.xml");
//    if (doc.ErrorID() != 0) {
...
//    }
//}
//void XmlReader::xmlReadMsmServerInfo()
//{
//    XMLDocument doc;
//    doc.LoadFile("hierarchy_tree.xml");
//    if (doc.ErrorID() != 0) {
